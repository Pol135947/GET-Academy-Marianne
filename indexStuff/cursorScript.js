...
const handleOnMove = e => {
    const mousePosition = { x: e.pageX, y: e.pageY } // Use pageX and pageY
    ...
    // Use document instead of window to track movement everywhere
    document.addEventListener("mousemove", handleOnMove);
    document.addEventListener("touchmove", e => handleOnMove(e.touches[0]));
    
    // Prevent issues when leaving the document
    document.addEventListener("mouseleave", () => updateLastMousePosition(originPosition));
